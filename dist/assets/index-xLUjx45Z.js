...
function rc(e) {
  ...
  function m(f, c, p, w) {
    ...
    if (typeof p == "object" && p !== null) {
      ...
      if (On(p) || Sn(p)) return x !== null ? null : h(f, c, p, w, null);
      Pr(f, p);
    }
    return null;
  }
  function k(f, c, p, w, x) {
    ...
    if (typeof w == "object" && w !== null) {
      switch (w.$$typeof) {
        ...
        case ot:
          var _ = w._init;
          return k(f, c, p, _(w._payload), x);
      }
      if (On(w) || Sn(w)) return (f = f.get(p) || null), h(c, f, w, x, null);
      Pr(c, w);
    }
    return null;
  }
    ...
    if (
      ...
      switch (p.$$typeof) {
        ...
        case $t:
          ...
          return i(f);
        case ot:
          return (_ = p._init), T(f, c, _(p._payload), w);
      }
...
function Xi(e, t) {
  switch ((A(er, t), A(bn, e), A(We, cr), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function Np(e, t, n) {
  switch (t.tag) {
    ...
    case 10:
      ...
      A(ul, r._currentValue), (r._currentValue = l);
      break;
    case 13:
...
function Ac(e) {
  ...
  t !== null && ((e.alternate = null), Ac(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[$e], delete t[Zn], delete t[Xo], delete t[dp], delete t[pp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Bc(e, t, n) {
  for (var r = (e.mode & 1) !== 0; E !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (E = o)) : ks(e);
  }
}
function ks(e) {
  for (; E !== null; ) {
...
function Pt(e, t, n) {
  var r = j,
    l = Ne.transition;
  try {
    (Ne.transition = null), (j = 1), Ap(e, t, n, r);
  } finally {
    (Ne.transition = l), (j = r);
  }
  return null;
...
const Yp = ({ query: e, onSmash: t }) =>
  ...
  Gp = ({ onEnter: e, onType: t, newName: n, newNumber: r }) =>
    I.jsxs("form", {
      onSubmit: e,
      children: [
        I.jsxs("div", {
  ...
  qp = ({ query: e, persons: t, deleteContact: n }) =>
    I.jsx("ul", {
      children:
        e === ""
          ? t.map((r) =>
              I.jsxs(
                "li",
                {
                  children: [
                    ...
                    I.jsx("button", {
                      onClick: () => {
                        window.confirm(`Do you want to delete ${r.name}`) &&
                          n(r);
                      },
                      children: "delete",
                    }),
          ...
          : t
              .filter((r) => new RegExp(e, "gi").test(r.name))
              .map((r) =>
                I.jsxs(
                  "li",
                  {
...
const Rh = (e) => {
  ...
  Oh = Qe("AsyncFunction"),
  Lh = (e) => e && (Ml(e) || Pe(e)) && Pe(e.then) && Pe(e.catch),
  g = {
    isArray: vn,
    isArrayBuffer: ef,
    isBuffer: bp,
...
function Il(e, t, n) {
  ...
  function h(y, v, T) {
    ...
    return mi(y) ? !0 : (t.append(Ls(T, v, o), a(y)), !1);
  }
  const d = [],
    m = Object.assign(Dh, {
      defaultVisitor: h,
...
const pf = {
  ...
  Bh = ((e) => hf && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(
  ...
  gf = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !sm(n) && ((r = yi[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
const vi = { assertOptions: am, validators: vu },
  lt = vi.validators;
class gl {
  constructor(t) {
    (this.defaults = t),
...
const Bl = "/api/persons",
  hm = () => W.get(Bl).then((e) => e.data),
  mm = (e) => W.post(Bl, e).then((t) => t.data),
  ym = (e) => W.delete(`${Bl}/${e.id}`).then((t) => t.data),
  vm = (e) => W.put(`${Bl}/${e.id}`, e).then((t) => t.data),
  zr = { getAll: hm, create: mm, del: ym, update: vm };
function gm({ message: e, messageStyle: t }) {
  return e ? I.jsx("div", { className: t, children: e }) : null;
}
const wm = () => {
  const [e, t] = Be.useState([]),
    ...
    k = (f) => {
      f.target.id === "name" ? r(f.target.value) : o(f.target.value);
    };
  Be.useEffect(() => {
    zr.getAll().then((f) => {
      t(f);
  ...
  const y = (f) => {
      ...
      if (e.find((p) => p.name === n && p.number === l))
        alert(`${n} is already added to phonebook!`);
      else if (e.find((p) => p.name === n && p.number !== l))
        if (window.confirm("replace the number with new one?")) {
          const p = e.find((w) => w.name === n && w.number !== l);
          v(p);
        } else return;
      else
        zr.create(c).then((p) => {
    ...
    v = (f) => {
      const c = { ...f, number: l };
      zr.update(c).then((p) => {
        t(e.map((w) => (w.id === p.id ? p : w))),
          a(`${p.name}'s phone number updated successfully!`),
          d("success"),
          setTimeout(() => {
            a(null), d(null);
          }, 2e3);
    ...
    T = (f) => {
      zr.del(f)
        .then((c) => {
          t(e.filter((p) => p.id !== c.id)),
            a(`${c.name} has been deleted successfully!`),
            d("success"),
            setTimeout(() => {
              d(null), a(null);
            }, 2e3);
        ...
        .catch((c) => {
          d("error"),
            a(`${f.name} has already been deleted!`),
            setTimeout(() => {
              d(null), a(null);
            }, 2e3);
        });
  ...
  return I.jsxs("div", {
    children: [
      I.jsx("h1", { children: "Phonebook" }),
      I.jsx(gm, { message: s, messageStyle: h }),
      I.jsx(Yp, { query: i, onSmash: m }),
      I.jsx("h2", { children: "Add a new number" }),
      I.jsx(Gp, { onEnter: y, onType: k, newName: n, newNumber: l }),
      I.jsx("h2", { children: "Numbers" }),
      I.jsx(qp, { query: i, persons: e, deleteContact: T }),
    ],
  });
};
ko.createRoot(document.getElementById("root")).render(
  I.jsx(If.StrictMode, { children: I.jsx(wm, {}) })
);
